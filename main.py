...
def seed_subjects():
    ...
    cursor.executemany(sql, zip(subjects, list_teachers_id))
...
def seed_grades():
    ...
    def get_lits_date(start_date, finish_date) ->  List[date]:
        result = []
    ...
    list_date = get_lits_date(start_date, finish_date)
